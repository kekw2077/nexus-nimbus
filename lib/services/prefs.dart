...
class Prefs {
  ...
  ///
  /// В настройках приложения, а не в реестре, как когда-то у WinSparkle:
  /// та отметка жила вечно и находилась только руками — давняя ловушка,
  /// записанная в STATUS. Здесь она видна в настройках и снимается кнопкой.
