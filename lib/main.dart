...
Future<void> main() async {
  ...
  // и ждать его на старте нечего. Когда установщик запущен, выходим так же,
  // как из меню трея — со снятым перехватом закрытия и без значка.
  updater.onQuit = tray.quit;
  await updater.init();
