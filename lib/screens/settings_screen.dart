...
///
/// Установщик прежней версии открывается в браузере, а запускает его
/// человек: откат — редкий и осознанный шаг, и пусть он выглядит именно так.
/// Проверять подпись приложение теперь умеет само (UpdaterService.install),
/// так что провести откат через то же окно можно — когда понадобится.
