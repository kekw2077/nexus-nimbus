...
Future<void> showAccounts(
  ...
  return showDialog<void>(
    ...
    builder: (ctx) {
      ...
      // Ширину берём у самой карточки, а не числом: панель — её
      // продолжение вверх, и любое своё число вылезало бы за границу
      // боковой полосы, стоило поменять её ширину.
      final width = anchor.width.clamp(200.0, 360.0);
      const gap = 8.0;
