...
# копии до 0.3.4 ставили обновления через WinSparkle 0.8.1, а он читает
# только первый <item> и сравнивает с установленной версией его одного.
# Пока наверху стояла 0.1.0, ни одна копия обновления не видела, хотя своё
# окно приложение показывало (оно сортирует по версии).
...
# Ключи, с которыми приложение запустит установщик. Без них получился бы
# полный мастер установки вместо перезапуска.
